...
class HwController
{
	...
	public:
		...
		virtual	int set_hw_info_by_struct(void hw_struct) = 0;		/* Pass struct of data type for setting HW info */
		virtual int run_hw_info_detect() = 0;						/* TODO Need pthread?  Pass struct of data type for checking HW info */
		virtual	int get_hw_info_by_struct(void hw_struct) = 0;		/* Return struct of date type for getting HW info */
}
